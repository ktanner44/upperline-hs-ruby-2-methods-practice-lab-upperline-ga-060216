...
def trip_length
  "The trip will take #{3 * 156} seconds."
end
...
def everything_is_awesome
  5.times do
    return "Everything is Awesome! Everything is Awesome! Everything is Awesome! Everything is Awesome! Everything is Awesome!"
  end
end
...
def remaining_trips
  "There are #{(18/2.75).to_i} trips left on the MetroCard."
end
